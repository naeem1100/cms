        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 style="font-size: 40px; font-family: Helvetica; text-align: center; font-weight:bold; margin-left:50px;" class="text-primary">Here's insert the records</h1>
                ...
                <!-- Begin Page Content -->
                        ...
                        <div class="container">
                            ...
                            <form action="programming.php" method="post">
                                ...
                                <input type="submit" name="insert_data" class="btn btn-primary mt-3" value="insert">
                                <a href="show.php" class="btn btn-success mt-3">View records</a>
                            </form>
